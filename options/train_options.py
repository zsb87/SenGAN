...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--eval_freq', type=int, default=100, help='frequency of evaluating results')
        ...
        self.parser.add_argument('--start_epoch', type=int, default=0, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
...
if __name__ == '__main__':
    ...
    opt.start_epoch = opt.start_epoch + 1
